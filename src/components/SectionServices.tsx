    ...
    <section className='relative w-full h-[965px]'>
      <Container>
        <div className='flex-1 max-w-[594px] pt-32'>
          ...
          <p className='text-lg max-w-[554px] mb-16 text-secondary-gray'>Veja como você pode cuidar das suas finanças pelo app Itaú de forma segura, rápida e o melhor, no conforto da sua casa.</p>
          <ul className='flex flex-col items-start gap-9'>
            ...
            <li className='flex items-center gap-9 pb-9 border-b-[1px] border-opacity-gray'>
              ...
              <p className='flex-1 text-txt-gray pr-2'>Diversar opções de investimentos de acordo com o seu perfil de investidor</p>
            </li>
            <li className='flex items-center gap-9'>
              <div className='w-7 h-7 flex items-center justify-center'>
                <Image src={CardIcon} alt="Icon card"/>
              </div>
              <p className='flex-1 text-txt-gray pr-2'>Acompanhe a fatura do seu cartão de crédito e fça compras online com seu cartão virtual</p>
            </li>
          </ul>
        </div>
      </Container>
